...
## Core Stack
- **Language:** [Extract from package.json / project files (e.g., TypeScript v5.0+)]
- **Frontend Framework:** [Extract framework]
- **Backend Framework:** [Extract framework]
- **Database:** [Extract database type]

## Secondary Libraries
- **State Management:** [Extract library, e.g., Zustand]
- **Data Fetching:** [Extract library, e.g., TanStack Query]
- **Styling:** [Extract library, e.g., Tailwind CSS]
- **Component Library:** [Extract library, e.g., shadcn/ui]
