...
## Active Bugs
| Issue | Severity | Location | Description | Workaround |
| :--- | :--- | :--- | :--- | :--- |
| [Extract issue] | `[High/Low]` | `[File Path]` | [Description] | [Temporary Fix] |

## Technical Debt (To Refactor)
- **[Feature name]:** [Extract debt description, e.g., Prop-drilling over Context]
